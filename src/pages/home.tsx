    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <footer className="mt-16 text-center">
          ...
          {(settings?.instagramUrl || settings?.whatsappUrl || settings?.youtubeUrl) && (
            <div className="mt-2 flex items-center justify-center gap-4">
              {settings?.instagramUrl && (
                <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition">
              ...
              {settings?.whatsappUrl && (
                <a href={settings.whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {settings?.youtubeUrl && (
                <a href={settings.youtubeUrl} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
